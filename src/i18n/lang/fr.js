export default {
  ...
  text: {
    ...
    signed: 'Signé par',
    signatureStatusSuccess: 'Cette signature a été vérifié avec succès',
    signatureStatusTestSuccess: 'Cette signature a été vérifié avec succès mais la blockchain utilisée est de test',
