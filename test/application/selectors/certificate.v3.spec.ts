...
import testnetV3PdfFixture from '../../fixtures/v3/testnet-v3.0-beta-display-pdf.json';
...
describe('certificate selectors test suite', function () {
  ...
  describe('given the certificate is a V3.2 version', function () {
    const signersObjectForFixture: Signers[] = [
      {
        signingDate: '2024-10-22T17:46:57Z',
        ...
        chain: BLOCKCHAINS.mocknet,
        transactionId: 'undefined',
        transactionLink: '',
        rawTransactionLink: ''
      }
    ];
    stubCertificateVerify(v3_2FixtureMocknet as any, signersObjectForFixture);
    ...
    describe('getIssuedOn selector', function () {
      it('should return the date of issuance', function () {
        ...
        expect(getIssuedOn(state)).toBe('2024-03-01T00:00:00Z');
      });
    });
    ...
    describe('getIssueDate selector', function () {
      it('should return a readable date', function () {
        ...
        expect(getIssueDate(state)).toBe('Mar 1, 2024');
      });
    });
    ...
    describe('getRecipientName selector', function () {
      it('should return the recipient\'s name', function () {
        ...
        expect(getRecipientName(state)).toBe('John Smith');
      });
    });

    describe('getCertificateTitle selector', function () {
      it('should return the certificate\'s title (name property)', function () {
        const state = store.getState();

        expect(getCertificateTitle(state)).toBe('Canadian Id Card');
      });
    });

    describe('getCertificateDescription selector', function () {
      it('should return the certificate\'s description', function () {
        const state = store.getState();

        expect(getCertificateDescription(state)).toBe('A Blockcerts example (not an official document) highlighting various VC v2 spec items');
      });
    });
    ...
    describe('getIssuerName selector', function () {
      it('should return the issuer\'s name', function () {
        ...
        expect(getIssuerName(state)).toBe('Blockcerts Organization');
      });
    });
    ...
    describe('getTransactionLink selector', function () {
      it('should return the transaction\'s link', function () {
        ...
        // empty string because mocknet
        expect(getTransactionLink(state)[0]).toEqual('');
      });
    });

    describe('getTransactionId selector', function () {
      it('should return the transaction\'s id', function () {
        const state = store.getState();

        // undefined because mocknet
        expect(getTransactionId(state)[0]).toEqual('undefined');
      });
    });
    ...
    describe('getChain selector', function () {
      it('should return the chain name', function () {
        ...
        expect(getChain(state)[0]).toBe('Mocknet');
      });
    });
    ...
    describe('getPublicKey method', function () {
      it('should return the publicKey of the issuer associated with the blockcerts issuance', function () {
        const state = store.getState();
        expect(getIssuerPublicKey(state)[0]).toBe('This mock chain does not support issuing addresses');
      });
    });
  });
    ...
    describe('given the certificate has a display property', function () {
      describe('and the contentMediaType is not defined', function () {
        ...
        it('should return null', function () {
          const state = store.getState();
          expect(getDisplayContentTypeFromState(state)).toBeNull();
        });
      });

      describe('and the contentMediaType is defined', function () {
        beforeEach(async function () {
          await store.dispatch(updateCertificateDefinition(testnetV3Fixture as any));
        });
  ...
  describe('getDisplayContentEncoding selector', function () {
    describe('given the certificate has a display property', function () {
      ...
      describe('and the contentEncoding is defined', function () {
        beforeEach(async function () {
          await store.dispatch(updateCertificateDefinition(testnetV3PdfFixture as any));
        });

        it('should return the value of the contentMediaType', function () {
          const state = store.getState();
          expect(getDisplayContentEncodingFromState(state)).toBe('base64');
        });
      });
    });
  });
    ...
    describe('given the certificate has a display property', function () {
      describe('and the content is not defined', function () {
        ...
        it('should return an empty string', function () {
          const state = store.getState();
          expect(getDisplayContentFromState(state)).toBe('');
        });
      });
