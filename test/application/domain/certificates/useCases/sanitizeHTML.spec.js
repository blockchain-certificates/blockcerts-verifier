...
describe('domain certificates sanitizeHTML method test suite', function () {
  ...
  it('should remove script tags from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><script>alert("XSS")</script></section>'
    };

    const expectedOutput = '<section><h1>Testing</h1></section>';

    expect(domain.certificates.sanitizeHTML(definition).displayHtml).toBe(expectedOutput);
  });

  it('should remove style tags from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><style>alert("XSS")</style></section>'
    };
  ...
  it('should remove event attributes from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><div onclick="javascript:alert(\'yo\')">Yo</div></section>'
    };
  ...
  it('should keep style attributes from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><div style="display:inline;">Yo</div></section>'
    };
  ...
  it('should filter style attributes from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><div style="display:inline;background:url(java/**/script:alert(1)">Yo</div></section>'
    };
  ...
  it('should keep class attributes from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><div class="content">Yo</div></section>'
    };
  ...
  it('should keep valid href attribute from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><div><a href="http://lm.com/yo.html">Yo</a></div></section>'
    };
  ...
  it('should keep valid src attribute from a definition', function () {
    const definition = {
      displayHtml: '<section><h1>Testing</h1><div><img src="http://lm.com/yo.jpg" alt="MultiYO" />Yo</div></section>'
    };
